...
length_letter = 3 # dynamically incremented for each analogical equation, based on the size of the alphabet
length_var = 4
length_gr = 2
#--------------
...
def solveAnalogy(A, B, C):
    ...
    len_letter = length_letter + math.ceil(math.log(nb_char, 2))
